...
st.set_page_config(page_title="Inferential Statistics ", layout="wide", initial_sidebar_state="expanded"
)
...
def page_home():
    ...
    with col2:
        ...
        st.video("https://raw.githubusercontent.com/Berier17/inference-tests-explorer/main/SamplingDistribution.mp4")
...
def page_regression():
    ...
    st.video("https://raw.githubusercontent.com/Berier17/inference-tests-explorer/main/Regression3D.mp4")    
    st.markdown("### Model")
